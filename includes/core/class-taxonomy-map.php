...
final class Taxonomy_Map {
	...
	public static function aliases(): array {
		$map = array(
			...
			'disease'              => array( 'disease_post' ),
			'treatment'            => array( 'treatment_post' ),
			'remedy'               => array( 'remedy_post' ),
			'materia_medica'       => array( 'materia_medica_post' ),
			'clinical_education'   => array( 'clinical_education_post' ),
			'clinical_experience'  => array( 'clinical_experience_post', 'treatment_experience' ),
